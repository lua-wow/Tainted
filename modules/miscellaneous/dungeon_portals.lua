...
local portals = {
    -- ???
    [0] = { spells = { default = 467546 }, mapID = 0 }, -- Cinderbrew Meadery (Path of the Waterworks)
    ...
    -- Shadowlands Raids
    [0] = { spells = { default = 373190 }, mapID = 0 }, -- Castle Nathria (Path of the Sire)
    ...
    -- Dragonflight Raids
    [0] = { spells = { default = 432254 }, mapID = 0 }, -- Vault of the Incarnates
    [0] = { spells = { default = 432257 }, mapID = 0 }, -- Aberrus, the Shadowed Crucible
    [0] = { spells = { default = 432258 }, mapID = 0 }, -- Amirdrassil, the Dream's Hope
    ...
    [0] = { spells = { default = 1226482 }, mapID = 0 }, -- Liberation of Undermine
}
